...
function getData(index){
  // removeHash(data[index].id, data[index].url, data[index].index)
...
function removeHash (state, uri, title) { 
    log(state, title, window.location.pathname + uri)
    // history.pushState('', document.title, window.location.pathname + window.location.search);
    // history.pushState({state: state}, title, window.location.pathname + window.location.search);
    history.pushState({state: state}, title, 'index.html');
}
